...
public class Gun : MonoBehaviourPun, IPunObservable
{
    ...
    // 게임오브젝트 데이터 동기화 메서드
    // Serializeable field로 선언된 변수들을 주기적으로 클라이언트 간에 동기화시켜준다.
    ...
    // 탄약을 추가하는 메서드
    // PunRPC Custom Attribute를 선언하여 RPC로 동작하도록 한다.
    // (RPC란? Remote Procedure Call로서 원격에서 함수를 콜하는 것을 의미.)
    [PunRPC]
